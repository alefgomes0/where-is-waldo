...
export const MapHeader = () => {
  ...
  const headerClass =
    cityName === "pallet"
      ? ""
      : "bg-black text-neutral-300 border-b-4 border-neutral-700";

  return (
    <header
      className={`grid grid-rows-1 grid-cols-[100px_2fr_auto] md:grid-cols-[2fr_3fr_1fr] items-center h-[68px] ${headerClass} px-1 md:px-8 py-8 md:py-2 shadow-[0_2px_2px_0_rgba(0,0,0,0.3)]`}
    >
      ...
      <div className="flex items-center gap-2 md:gap-6 justify-self-center md:justify-self-end row-start-1 row-end-2 col-start-2 col-end-3">
