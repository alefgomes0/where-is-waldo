...
export const Header = () => {
  ...
  return (
    <header className="grid grid-rows-1 md:grid-cols-[2fr_3fr_1fr] items-center h-[68px] px-1 md:px-8 py-8 md:py-2 shadow-[0_2px_2px_0_rgba(0,0,0,0.3)] ">
      <h1 className="text-2xl md:text-3xl font-semibold row-start-1 row-end-2 opacity-80 pr-1 md:pr-0">
        Where is...
      </h1>
      <div className="flex items-center gap-2 md:gap-6 justify-self-start md:justify-self-end row-start-1 row-end-2 ">
